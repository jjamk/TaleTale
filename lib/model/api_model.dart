...
class lin_list_ApiResponse {
  ...
  factory lin_list_ApiResponse.fromJson(Map<String, dynamic> json) {
    ...
    final terList =
        terListJson?.map((item) => lin_list_Terminal.fromJson(item)).toList() ??
            [];
...
class load_info_ResponseData {
  ...
  factory load_info_ResponseData.fromJson(Map<String, dynamic> json) {
    ...
    final terList =
        terListJson.map((item) => load_info_Terminal.fromJson(item)).toList();

    final List<dynamic> corListJson = json['COR_LIST'];
    final corList =
        corListJson.map((item) => load_info_Company.fromJson(item)).toList();
...
class ibt_info_ResponseData {
  ...
  factory ibt_info_ResponseData.fromJson(Map<String, dynamic> json) {
    return ibt_info_ResponseData(
      ...
      seatList: List<ibt_info_Seat>.from(
          json['SEAT_LIST'].map((x) => ibt_info_Seat.fromJson(x))),
      ...
      dist: json['DIST'],
      linList: List<ibt_info_Lin>.from(
          json['LIN_LIST'].map((x) => ibt_info_Lin.fromJson(x))),
